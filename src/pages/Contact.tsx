      ...
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm text-stone-700 dark:text-stone-300">
          <div className="space-y-2 border-l-2 border-amber-500 pl-4">
            ...
            <p>Office: <a href="tel:+13102783311" className="hover:text-amber-600 dark:hover:text-amber-500 transition-colors cursor-pointer font-semibold underline decoration-amber-500/30">+1 (310) 278-3311</a></p>
            <p>Discreet: <a href="tel:+13102783312" className="hover:text-amber-600 dark:hover:text-amber-500 transition-colors cursor-pointer font-semibold underline decoration-amber-500/30">+1 (310) 278-3312</a></p>
          </div>
